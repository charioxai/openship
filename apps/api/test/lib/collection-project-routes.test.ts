...
import { staleServiceKindForProjectShape } from "../../src/modules/projects/project-crud.service";
...
describe("create-scoped folder staging routes", () => {
  ...
  it("allows only isolated upload steps before project creation", async () => {
